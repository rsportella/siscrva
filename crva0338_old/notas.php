        ...
        <table class="table dataTable table-striped table-bordered no-footer">
            ...
            <tbody>
                ...
                while ($linha = $result->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td>"
                    . "<a href='cupom.php?parametros=$linha[idnota]' data-toggle='tooltip' data-placement='top' title='Reimprimir' target='_blank'><i class='fa fa-print'></i></a>"
                    . "<a class='excluir' href='?modal=excluir&nota=$linha[idnota]' data-toggle='tooltip' data-placement='top' title='Excluir'><i class='fa fa-trash'></i></a>"
                    . "</td>";
                    echo '</tr>';
