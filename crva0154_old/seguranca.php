...
$_PS['funcionario'] = 'u842352461_0154';        // Usuário MySQL
$_PS['banco'] = 'u842352461_0154';              // Banco de dados MySQL
$_PS['senha'] = 'S^3n7hb$PO&K';           // Senha MySQL
...
function validaUsuario($funcionario, $senha) {
    ...
    if (empty($resultado)) {
        ...
        if ($_PS['validaSempre']) {
            ...
            $_SESSION['funcionarioSenha'] = $senha;
